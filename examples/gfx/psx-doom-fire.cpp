...
std::vector<std::array<int, 3>> colors = {
    ...
    {207, 137, 23},  {199, 135, 23},  {199, 143, 23},  {199, 151, 31},
...
int getTileValue(int x, int y) { return tiles.at((x * heightQuantity) + y); }

double sortNumber() { return (std::rand() / (double)RAND_MAX); }
...
void Game::event() {
    ...
    this->running =
        !(input_handler.read("quit") || input_handler.read(SDL_QUIT));
}
